...
<head>
    ...
    <title>Register - DEER BAKERY & CAKE</title>
    ...
    <div class="register-container">
        <div class="register-card" data-aos="fade-up">
            <div class="register-header">
                ...
                <p class="brand-subtitle" data-aos="fade-up" data-aos-delay="500">Create Your Account</p>
            </div>

            <div class="register-body">
                <h4 class="welcome-title" data-aos="fade-up" data-aos-delay="600">Join Our Team!</h4>
